...
**** Peso muerto de competencia
- El inicio est� mejorando harto, eso s� trata de aceptar mejor que tu espalda
  quede mas horizontal, eso es por tus proporciones y es la postura mas
  ventajosa
- Luego de hacer el hook, p�gale unos tirones a la barra para que se ajuste bien
...
| Buenos d�as sentada                 | x15@8, 3x10                         | A      |
...
| Extensi�n de triceps       | x20@9, 3x15      | A      |
...
*** Ciclo 3:
 ...
 | Ejercicio                             | Protocolo                 | Bloque |
 |---------------------------------------+---------------------------+--------|
 | Press banca de competencia            | x1@8, x5@8, 10%, 3x5, 2x2 | A      |
...
- De momento lo �nico que me es relevante de este movimiento es evitar
  molestias, as� que cualquiera que salga me la informas para hacer las
...
- Del suelo hasta bajo de las rodillas tu misi�n es mantener la
  posici�n los m�s poible sin extender mucho las rodillas
- Desde las rodillas hasta arriba, busca un bloqueo explosivo
**** Press banca agarre cerrado
- Mas tensi�n en el pecho, trata de que la barra apenas si toque el
...
**** Sentadilla de competencia
- Correcci�n del cuello hacia atr�s
...
- Mantener la tensi�n constante por 1-2 segundos, luego levantar sin
  volver a perder tensi�n
**** Peso muerto sumo
- Aplicar los mismos comentarios que para peso muerto convencional
*** 15/07/2019, ciclo 1, bloque a
**** Sentadilla de competencia
- De aqu� en adelante utilizar la postura con el torso mas inclinado que
  lograste en esta sesi�n
- Bajar un poquito menos justo hasta despu�s de paralelo
- Reducir la velocidad, que el descenso sea suave y controlado
**** Banca de competencia
- Concentrarse en hacer tensi�n con las piernas durante todo el movimiento
** Registro de progreso
*** Ciclo 1
#+TBLNAME:ciclo1_fran
| Ejercicio                       | RPE | Peso | Fecha      |
